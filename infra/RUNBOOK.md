...
- `cors_allowed_origins` (admin/iOS dev origins; used for API CORS and browser-based direct S3 uploads, e.g. `https://admin.mylooped.app,https://admin.looped-social.com,https://mylooped.app,https://www.mylooped.app,https://looped-social.com,https://www.looped-social.com`)
