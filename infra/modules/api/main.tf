  ...
  container_definitions = jsonencode([
    {
      ...
      environment = concat(
        [
          ...
          { name = "DEVICES_APP_ATTEST_MODE", value = var.devices_app_attest_mode },
          { name = "DEVICES_APP_ATTEST_CHALLENGE_TTL", value = var.devices_app_attest_challenge_ttl },
          { name = "DEVICES_APP_ATTEST_TRUST_TTL", value = var.devices_app_attest_trust_ttl },
          { name = "DEVICES_APP_ATTEST_ALLOW_INSECURE_OBSERVED_TRUST", value = tostring(var.devices_app_attest_allow_insecure_observed_trust) },
          { name = "UL_APPLE_TEAM_ID", value = var.universal_links_apple_team_id },
          { name = "UL_IOS_BUNDLE_ID", value = var.universal_links_ios_bundle_id },
          { name = "UL_CACHE_MAX_AGE_SECONDS", value = tostring(var.universal_links_cache_max_age_seconds) },
          { name = "UL_AASA_VERSION", value = var.universal_links_aasa_version },
