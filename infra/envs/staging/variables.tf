...
variable "domain_name" {
  ...
  default     = "api-staging.mylooped.app"
}

variable "acm_certificate_arn" {
  type        = string
  description = "ACM certificate ARN for HTTPS on the ALB. Leave blank to run HTTP-only."
  default     = ""
}
...
variable "image_tag" {
  type        = string
  description = "ECR image tag to run (e.g. main, staging, prod)."
  default     = "main"
}
