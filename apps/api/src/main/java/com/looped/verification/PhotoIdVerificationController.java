...
public class PhotoIdVerificationController {
    ...
    public record SubmitRequest(@NotBlank String uploadSessionId, @NotNull Documents documents) {}

    public record Documents(@NotBlank String selfieKey, @NotBlank String idFrontKey, String idBackKey) {}
}
