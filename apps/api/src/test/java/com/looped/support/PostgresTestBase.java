    ...
    void cleanDatabase() throws Exception {
        try (Connection c = DriverManager.getConnection(postgres.getJdbcUrl(), postgres.getUsername(), postgres.getPassword());
            ...
            s.execute("TRUNCATE TABLE conversation_messages, conversation_message_requests, channel_messages, notifications, comment_likes, comments, " +
                    ...
                    "principals, verifications, hashtag_posts, hashtags, community_verifications, community_follows, community_requests, community_domains, community_sector_links, feedback, communities, user_loops, loops, admin_invites, admin_users, app_settings, user_community_bans, user_tombstones, users, companies " +
